...
def index():
    if request.method == 'POST':
        ...
        try:
            # dbConn = pymongo.MongoClient("mongodb+srv://mongodbtest:mongodbtest@cluster0.vu9ic.mongodb.net/crawlerDB?retryWrites=true&w=majority")
            dbConn = pymongo.MongoClient("mongodb+srv://mongodbtest:mongodbtest@cluster0.vu9ic.mongodb.net/test?retryWrites=true&w=majority")
